...
export const services = [
  ...
  },
  {
    ...
    blurb: 'Generative AI IVR: Natural, multilingual voice conversations that route or escalate without rigid menu trees.',
    useCases: [
  ...
  },
  {
    ...
    blurb: 'AI Chatbots: Context-aware conversations across WhatsApp, web and social, with seamless handoff to a human agent.',
    useCases: [
