...
export const services = [
  {
    ...
    desc: 'From the first interaction to final resolution, our trained customer support teams manage calls, emails and chats with empathy, accuracy and defined service levels. Backed by nearly two decades of contact centre experience, we become an extension of your customer service team.',
  ...
  },
  {
    ...
    desc: 'Move beyond traditional Press 1, Press 2 IVRs. Our AI voice agents understand natural conversations, respond in multiple languages, handle routine customer requests and seamlessly transfer complex interactions to your human team.',
    stat: '24/7 • Multilingual • Natural Conversations • Human Escalation',
    color: '#2563eb',
    accent: '#06b6d4',
  ...
  },
  {
    ...
    desc: 'Deploy AI powered chat agents across WhatsApp, your website and other digital channels. From answering enquiries and qualifying leads to booking appointments, providing service updates and handling support requests, the service is available 24/7 with seamless escalation to your team whenever human intervention is needed.',
    stat: 'WhatsApp • Web • Multilingual • Human Escalation',
    color: '#7c3aed',
    accent: '#d946ef',
    video: chatVideo,
  ...
  },
  {
    ...
    desc: 'Automate repetitive processes such as lead allocation, follow ups, reminders, escalations, ticket updates and customer notifications. We connect your CRM, communication channels and business workflows so your teams spend less time on routine tasks and more time where human attention matters.',
  ...
  },
  {
    ...
    title: 'Turn Customer Interactions\nInto Business Insights',
    desc: 'Get real time visibility into call volumes, response times, lead status, service levels, customer issues and team performance. Our dashboards and MIS reports help management identify trends, spot bottlenecks and make faster, data backed decisions.',
  ...
  },
  {
    ...
    desc: 'Every business works differently. We build customized CRM modules, ticketing systems and workflow solutions around your sales, service and field operations, or integrate automation with the systems you already use.',
    stat: 'Customized • Integrated • Automated • Your Data',
    color: '#3b82f6',
    accent: '#7c3aed',
